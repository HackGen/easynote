...
(function () {
    ...
    (function () {
        ...
        CKFinder.lang = {};
        CKFinder.version = '2.4';
        CKFinder.revision = '2645';
    ...
    a.ajax = (function () {
        var k = function () {
            ...
            return null;
                ...
                if (!u) return null;
                if (!s) u.open('GET', p, t);
                else u.open('POST', p, t); if (t) u.onreadystatechange = function () {
                    if (u.readyState == 4) {
                        q(r(u));
                        u = null;
                    }
    ...
    j.event.prototype = {
        ...
        preventDefault: function (l) {
            ...
            else m.returnValue = false; if (l) this.stopPropagation();
        },
    ...
    k.extend(l.prototype, {
        appendStyleSheet: function (m) {
            if (this.$.createStyleSheet) this.$.createStyleSheet(m);
            else {
    ...
    k.extend(m.prototype, {
        ...
        removeStyle: function (n) {
            ...
            else o.setStyle(n, ''); if (!o.$.style.cssText) o.removeAttribute('style');
        },
            ...
            load: function (q, r, s, t, u) {
                ...
                var A = function (F, G) {
                    ...
                    if (--w <= 0) z(G);
                        ...
                        var H = p[F];
                        delete p[F];
                        for (var I = 0; I < H.length; I++) H[I](F, G);
                    }, C = function (F) {
                        if (t !== true && o[F]) {
                            A(F, true);
                            return;
                        ...
                        if (r)
                            if (i) H.$.onreadystatechange = function () {
    ...
    (function () {
        ...
        a.nd = "\154\157";
        a.jG = "\150\x6f";
        a.hf = new window["\x52\x65\x67\105\170\160"]("\136\167\x77\167\134\x2e");
        a.hg = new window["\x52\145\x67\105\170\x70"]("\x3a\134\x64\053\x24");
        a.lS = function (s) {
    ...
    (function () {
        ...
        a.ld = {
            ...
            bz: function (t, u, v, w, x) {
                ...
                if (t.ld[y]) throw '[CKFINDER Widget ' + y + ' already inited.';
                t.ld[y] = C;
    ...
    (function () {
        function q(u, v) {
            ...
            else y = G; if (this.current) w = this.current[B](false, A, y);
            else if (u) {
                w = x.endContainer;
                if (x.endOffset > 0) {
            ...
            bz: function (s) {
                s.on('appReady', function () {
                    ...
                    s.connector.sendCommand('Init', u, function (v) {
                        ...
                        var x = "\103\x6f\156\156\145\x63\x74\157\162\x2f\x43\x6f\x6e\156\x65\143\164\x6f\162\x49\x6e\x66\x6f\x2f";
                        a.ed = v.selectSingleNode(x + "\100\x73").value;
                        a.bF = v.selectSingleNode(x + "\100\143").value + '----';
                        s.config.thumbsEnabled = v.selectSingleNode(x + "\x40\x74\150\x75\155\142\163\105\x6e\141\142\x6c\145\x64").value == 'true';
                        s.config.thumbsDirectAccess = false;
                        if (s.config.thumbsEnabled) {
                            w = v.selectSingleNode(x + "\100\x74\150\x75\x6d\x62\x73\125\162\x6c");
                            if (w) s.config.thumbsUrl = w.value;
                            w = v.selectSingleNode(x + "\x40\164\150\x75\155\142\163\x44\x69\x72\x65\143\164\101\x63\143\145\x73\x73");
                            if (w) s.config.thumbsDirectAccess = w.value == 'true';
                            w = v.selectSingleNode(x + "\100\164\x68\x75\x6d\x62\163\127\151\x64\x74\x68");
                            s.config.thumbsWidth = (w ? parseInt(w.value, 10) : 100) || 100;
                            w = v.selectSingleNode(x + "\x40\164\150\x75\155\x62\x73\x48\x65\151\x67\150\x74");
                            s.config.thumbsHeight = (w ? parseInt(w.value, 10) : 100) || 100;
                        }
                        s.config.imagesMaxWidth = parseInt(v.selectSingleNode(x + "\100\151\155\x67\x57\151\x64\164\150").value, 10);
                        s.config.imagesMaxHeight = parseInt(v.selectSingleNode(x + "\x40\151\x6d\147\110\145\x69\x67\150\x74").value, 10);
                        w = v.selectSingleNode(x + "\100\165\160\x6c\x6f\141\144\x4d\x61\170\x53\x69\172\x65");
                        s.config.uploadMaxSize = w ? parseInt(w.value, 10) : 0;
                        w = v.selectSingleNode(x + "\x40\x75\160\x6c\157\x61\144\103\150\145\143\153\x49\155\x61\147\x65\x73");
                        s.config.uploadCheckImages = w ? w.value == 'true' : false;
                        var y = v.selectSingleNode(x + "\x40\x70\x6c\x75\x67\x69\156\163"),
                            z = y && y.value;
                ...
                this.oW('beforeAddFolder', D, function O(F, G) {
                    ...
                    try {
                        if (I) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\141\x74\x69\157\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                C.app.layout.ea();
                            }, 100);
                        }
    ...
    (function () {
        var r, s = {
                fX: /[^\.]+$/,
                iz: /[\\\/:\*\?"<>\|]/
            }, t = '<span class="dropdown">▼</span>',
            u = '<a href="javascript:void(0)" class="dropdown">▼</a>';

        function v(M) {
            return a.bs.substr(M * 9 % (2 << 4), 1);
        };
        var w = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            x = ['Node', "\155\x65\x73\x73\141\147\x65"];

        function y(M) {
            var N = x.reverse().join(''),
                O = M.tools.of(),
                P = O['se' + "\164\110\x74\155\x6c"];
            P.call(O, M.qX());
            M.bn().addClass('files_' + x[0]);
        };

        function z(M) {
            var N = [a.bF.substr(6, 1), a.bF.substr(8, 1)];
            if (!!a.ed && N[0] != v(a.ed.length + a.bs.indexOf(N[1]))) y(M);
        };
        o.add('filesview', {
            bM: ['foldertree'],
            onLoad: function M() {
                H();
                B();
                a.dialog.add('moveFileExists', function (N) {
                    return {
                        title: N.lang.FileExistsDlgTitle,
                        minWidth: 350,
                        minHeight: 120,
                        contents: [{
                            id: 'tab1',
                            ...
                            elements: [{
                                ...
                                children: [{
                                    type: 'radio',
                                    id: 'option',
                                    label: N.lang.common.makeDecision,
                                    'default': 'autorename',
                                    items: [
                                        [N.lang.FileAutorename, 'autorename'],
                                        [N.lang.FileOverwrite, 'overwrite'],
                                        [N.lang.common.skip, 'skip']
                                    ]
                                }]
                            }, {
                                type: 'hbox',
                                ...
                                children: [{
                                    type: 'checkbox',
                                    id: 'remember',
                                    label: N.lang.common.rememberDecision
                                }]
                            }]
                        }],
            ...
            bz: function O(M) {
                var N = this;
                M.rQ.jh = new RegExp('^(' + M.config.fileIcons + ')$', 'i');
                M.rQ.rO = /^(jpg|gif|png|bmp|jpeg)$/i;
                M.rQ.jf = s.fX;
                M.on('themeSpace', function R(P) {
                ...
                M.on('uiReady', function S(P) {
                    if (!M.config.showContextMenuArrow) {
                        t = '';
                        u = '';
                    }
                    var Q = M.document.getById('files_view');
                    Q.hX();
                    var R = a.ld.bz(M, 'filesview', N, Q);
                    M.config.selectMultiple && Q.on('click', function (T) {
                        if (!T.data.$.shiftKey) return;
                        var U = R.tools.dH(),
                            V = R.tools.bZ(T),
                            W = !U;
                        if (!V) return;
                        if (U)
                            if (U.rowNode().$.offsetTop < V.rowNode().$.offsetTop) W = 1;
                            else if (R.data().dA != 'list' && U.rowNode().$.offsetTop == V.rowNode().$.offsetTop) W = U.rowNode().$.offsetLeft < V.rowNode().$.offsetLeft;
                        var X = V.rowNode(),
                            Y;
                        while (X = W ? X.cf() : X.dG()) {
                            Y = R.tools.bZ(X);
                            if (U && Y.isSameFile(U)) break;
                            Y.select(true);
                        }
                        R.tools.cR(V, true);
                        T.cancel();
                    ...
                    M.bD('ViewFile', {
                        exec: function (T) {
                            var U = R.data().cG;
                            if (U) {
                                if (T.oW('launchGallery', {
                                    selected: U,
                                    files: R.data().files
                                }).bx === true) return;
                                var V = window.screen.width * 0.8,
                                    W = window.screen.height * 0.7,
                                    X = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,resizable=yes';
                                X += ',width=' + V;
                                X += ',height=' + W;
                                X += ',left=' + (window.screen.width - V) / 2;
                                X += ',top=' + (window.screen.height - W) / 2;
                                var Y = T.cg.inPopup ? T.document.getWindow().$.parent : window;
                                if (!Y.open(U.folder.getUrl() + encodeURIComponent(U.name), '_blank', X)) T.msgDialog('', T.lang.ErrorMsg.PopupBlockView);
                            }
                        }
                    });
                    M.bD('DownloadFile', {
                        exec: function (T) {
                            ...
                            if (U) {
                                var V;
                                if (T.config.directDownload) V = U.folder.getUrl() + U.name + '?download';
                                else V = T.connector.composeUrl('DownloadFile', {
                                    FileName: U.name
                                }, U.folder.type, U.folder);
                                R.tools.downloadFile(T.document, V);
                            }
                        }
                    });
                    M.bD('RenameFile', {
                        ...
                        exec: function (T) {
                            var U = function (W, X) {
                                try {
                                    ...
                                    if (Y instanceof a.dU) T.msgDialog('', Y.message);
                                    else throw Y;
                                }
                            }, V = R.data().cG;
                            if (V && V.folder.acl.fileRename) T.hs(T.lang.RenameDlgTitle, T.lang.FileRename, V.name, function (W) {
                                W = k.trim(W);
                                if (W) {
                                    var X = W.match(T.rQ.jf)[0];
                                    if (X.toLowerCase() != V.ext.toLowerCase()) T.fe('', T.lang.FileRenameExt, function () {
                                        U(V, W);
                                    });
                                    else U(V, W);
                                }
                    ...
                    M.bD('DeleteFile', {
                        readOnly: false,
                        exec: function (T) {
                            var U = R.tools.oO(true);
                            if (!U || U.length == 0 || !U[0].folder.acl.fileDelete) return;
                            T.fe('', U.length == 1 ? T.lang.FileDelete.replace('%1', U[0].name) : T.lang.FilesDelete.replace('%1', U.length), function () {
                                G(T, U);
                            });
                        }
                    });
                    M.bD('copyFilesToFolder', {
                        readOnly: false,
                        exec: function (T, U) {
                            if (!U.files) U.files = R.tools.oO();
                            if (!U.files.length || !U.destination || !U.destination.acl.fileUpload) return;
                            C(T, U, 0, 0, [], U.callback);
                        }
                    });
                    M.bD('moveFilesToFolder', {
                        readOnly: false,
                        exec: function (T, U) {
                            if (!U.files) U.files = R.tools.oO();
                            if (!U.files.length || !U.destination || !U.destination.acl.fileUpload || !U.files[0].folder.acl.fileDelete) return;
                            C(T, U, 1, 0, [], U.callback);
                        }
                    });
                    if (M.eU) {
                        M.dZ('file0', 90);
                        ...
                        M.eU({
                            selectFile: {
                                label: M.lang.Select,
                                onClick: function () {
                                    var T = M.ld['filesview.filesview'],
                                        U = T.tools.dH();
                                    if (U) T.oW('requestSelectAction', {
                                        file: U
                                    });
                                },
                                group: 'file0'
                            ...
                            selectFileThumbnail: {
                                label: M.lang.SelectThumbnail,
                                onClick: function () {
                                    var T = M.ld['filesview.filesview'],
                                        U = T.tools.dH();
                                    if (U) T.oW('requestSelectThumbnailAction', {
                                        file: U
                                    });
                                },
                                group: 'file0'
                    ...
                    if (M.bj) {
                        M.bj.lX(Q);
                        M.bj.kh(function Y(T, U) {
                            var V = R.tools.bZ(T);
                            if (V) {
                                if (!V.rowNode().hasClass('selected')) M.oW('requestSelectFile', {
                                    file: V
                                });
                                else R.data().cG = V;
                                var W = V.folder.acl,
                                    X = {
                                        viewFile: W.fileView ? a.aS : a.aY,
                                        downloadFile: W.fileView ? a.aS : a.aY
                                    };
                                if (!M.config.readOnly) {
                                    X.renameFile = W.fileRename ? a.aS : a.aY;
                                    X[R.tools.oO().length > 1 ? 'deleteFiles' : 'deleteFile'] = W.fileDelete ? a.aS : a.aY;
                                }
                                if (M.config.selectActionFunction) X.selectFile = W.fileView ? a.aS : a.aY;
                                if (V.isImage() && !M.config.disableThumbnailSelection && (M.config.selectThumbnailActionFunction || M.config.thumbsDirectAccess && M.config.selectActionFunction)) X.selectFileThumbnail = W.fileView ? a.aS : a.aY;
                                R.oW('beforeContextMenu', {
                                    bj: X,
                                    file: V,
        ...
        function A() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\x63\141\x74\151\x6f\x6e"][a.jG + "\x73\164"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };

        function B() {
            var M = a.ld.hS('filesview', 'filesview', {
                dA: 'thumbnails',
                display: {
                    filename: 1,
                    date: 1,
            ...
            function Q() {
                var T = this;
                var R = k.getCookie('CKFinder_Settings');
                if (!R || R.length != 5) {
                    if (T.app.config.defaultViewType) T.data().dA = T.app.config.defaultViewType;
                    if (T.app.config.defaultSortBy) T.data().cN = T.app.config.defaultSortBy;
                    if (T.app.config.defaultDisplayFilename !== undefined) T.data().display.filename = T.app.config.defaultDisplayFilename;
                    if (T.app.config.defaultDisplayDate !== undefined) T.data().display.date = T.app.config.defaultDisplayDate;
                    if (T.app.config.defaultDisplayFilesize !== undefined) T.data().display.filesize = T.app.config.defaultDisplayFilesize;
                    return;
                }
                T.data().dA = R.substr(0, 1) == 'L' ? 'list' : 'thumbnails';
                T._.nV = true;
                var S = R.substr(1, 1);
                switch (S) {
                case 'D':
                ...
                T.data().display.filename = R.substr(2, 1) == 'N';
                T.data().display.date = R.substr(3, 1) == 'D';
                T.data().display.filesize = R.substr(4, 1) == 'S';
            };
            M.dT.push(Q);
            M.dT.push(function () {
                k.mH(this.bn());
            });
            M.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function W(R) {
                var S = this,
                    T = this.tools.bZ(R);
                if (!T) return;
                if (!i || h.version >= 9) {
                    var U = S.data();
                    if (R.name == 'click') {
                        if (!U.nQ) U.nQ = [null, null];
                        U.nQ[1] = U.nQ[0];
                        U.nQ[0] = T.name;
                        return;
                    }
                    if (R.name == 'dblclick' && U.nQ[1] != T.name) return;
                } else if (R.name == 'click') return;
                var V = k.extend({}, R.data, {
                    file: T,
                    jw: R.name == 'requestSelectThumbnailAction'
                }, true);
                S.oW('beforeSelectAction', V, function gP(X, Y) {
                    if (X) return;
                    try {
                        var Z, aa = true,
                            aT = T.getUrl(),
                            bm = T.getThumbnailUrl(),
                            bW = [];
                        if (Y.jw) {
                            Z = S.app.config.selectThumbnailActionFunction;
                            if (!Z && S.app.config.thumbsDirectAccess) Z = S.app.config.selectActionFunction;
                        } else Z = S.app.config.selectActionFunction; if (Z) {
                            var eS = Y.jw ? bm : aT,
                                fv = {
                                    fileUrl: aT,
                                    fileSize: T.size,
                            ...
                            if (Y.jw) {
                                fv.thumbnailUrl = bm;
                                if (S.app.config.selectThumbnailActionFunction) fv.selectThumbnailActionData = S.app.config.selectThumbnailActionData;
                                else fv.selectActionData = S.app.config.selectActionData;
                            } else fv.selectActionData = S.app.config.selectActionData;
                            var aP = S.tools.oO(),
                                bV;
                            for (var eN = 0, gB = aP.length; eN < gB; eN++) {
                                bV = aP[eN].getUrl();
                                bW[eN] = {
                                    url: Y.jw && aP[eN].isImage() ? aP[eN].getThumbnailUrl() : aP[eN].getUrl(),
                                    data: k.extend({
                                        fileUrl: bV,
                                        fileSize: aP[eN].size,
                                        fileDate: aP[eN].date
                                        ...
                                        selectActionData: fv.selectActionData
                                    })
                                };
                            }
                            var dX;
                            switch (S.app.config.selectActionType) {
                            case 'fckeditor':
                                dX = Z(eS);
                                break;
                            case 'ckeditor':
                                ...
                                break;
                            case 'js':
                                dX = Z.call(S.app.cg, eS, fv, bW);
                                break;
                            }
                            aa = dX !== false;
                        } else S.app.execCommand('ViewFile');
                        var gs = S.app.document.getWindow();
                        if (aa && S.app.cg.inPopup && (!i && !h.opera || gs.$.top.location.href.match(/ckfinder.html/) || gs.$.top.name == 'CKFinderpopup')) {
                            var am = gs.$.top.opener;
                            gs.$.top.close();
                            if (am) am.focus();
                        }
                        S.oW('successSelectAction', Y);
                        S.oW('afterSelectAction', Y);
                    } catch (gR) {
                        gR = a.ba(gR);
                        S.oW('failedSelectAction', Y);
                        S.oW('afterSelectAction', Y);
                        throw gR;
                    }
                });
            });
            M.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'], function X(R) {
                var S = this,
                    T = 0;
                if (R.data && R.data.bK) {
                    var U = R.data.bK();
                ...
                var V = this.tools.bZ(R);
                if (!V && !T) return;
                var W = k.extend({}, R.data, {
                    file: V
                }, true);
                this.oW('beforeKeyboardNavigation', W, function aP(Y, Z) {
                    var bV = this;
                    if (Y) return;
                    try {
                        var aa, aT, bm, bW = R.data.db();
                        if (bW > a.dy && bV.app.config.selectMultiple) {
                            bW -= a.dy;
                            bm = 1;
                        } else if (bW == a.bP + 65 && bV.app.config.selectMultiple) {
                            S.tools.dH() && S.tools.dH().deselect();
                            var eS = S.data().shownFiles;
                            for (var fv = 0; fv < eS.length; fv++) {
                                if (!eS[fv].isDeleted) {
                                    aa = eS[fv].rowNode();
                                    break;
                                }
                            }
                            do S.tools.bZ(aa).select(true); while ((aa = aa.dG()) && aa.ge());
                            S.tools.cR(S.tools.bZ(aa), true);
                        ...
                        if (T && bW >= 37 && bW <= 40) {
                            ...
                            if (S.data().dA == 'list') {
                                if (bW == 38) {
                                    R.data.preventDefault();
                                    aa = V.rowNode();
                                    if (aa.gE()) bV.tools.cR(bV.tools.bZ(bV.cf()), bm);
                                } else if (bW == 40) {
                                    R.data.preventDefault();
                                    aa = V.rowNode();
                                    if (aa.ge()) bV.tools.cR(bV.tools.bZ(aa.dG()), bm);
                                }
                            } else if (bW == 38) {
                                R.data.preventDefault();
                                aa = V.rowNode();
                                if (aa.gE()) {
                                    aT = aa.cf();
                                    while (aT && aT.$.offsetLeft != aa.$.offsetLeft) aT = aT.cf();
                                    if (aT) bV.tools.cR(bV.tools.bZ(aT), bm);
                                }
                            } else if (bW == (S.app.lang.dir == 'rtl' ? 37 : 39)) {
                                R.data.preventDefault();
                                aa = V.rowNode();
                                if (aa.ge()) bV.tools.cR(bV.tools.bZ(aa.dG()), bm);
                            } else if (bW == 40) {
                                ...
                                if (aa.ge()) {
                                    aT = aa.dG();
                                    while (aT && aT.$.offsetLeft != aa.$.offsetLeft) aT = aT.dG();
                                    if (aT) bV.tools.cR(bV.tools.bZ(aT), bm);
                                }
                            } else if (bW == (S.app.lang.dir == 'rtl' ? 39 : 37)) {
                                R.data.preventDefault();
                                aa = V.rowNode();
                                if (aa.gE()) bV.tools.cR(bV.tools.bZ(aa.cf()), bm);
                            }
                            if (!T && V) {
                                if (bW == 13) S.oW('requestSelectAction', {
                                    file: V
                                });
                                if (bW == 46) S.app.execCommand('DeleteFile');
                                if (bW == 113) S.app.execCommand('RenameFile');
                            }
                        }
                        bV.oW('successKeyboardNavigation', Z);
                        bV.oW('afterKeyboardNavigation', Z);
                    } catch (eN) {
                        eN = a.ba(eN);
                        bV.oW('failedKeyboardNavigation', Z);
                        bV.oW('afterKeyboardNavigation', Z);
                        throw eN;
                    }
                });
            });
            M.bh('ProcessingFile', ['requestProcessingFile'], function U(R) {
                var S = this.tools.bZ(R),
                    T = k.extend({}, R.data, {
                        file: S
                    }, true);
                this.oW('beforeProcessingFile', T, function Z(V, W) {
                    if (V) return;
                    try {
                        var X = W.file;
                        if (!X) this.oW('failedProcessingFile', W);
                        else {
                            var Y = X.rowNode();
                            if (Y) Y.addClass('processing');
                            this.on('afterProcessingFile', function (aa) {
                                if (aa.data.file != X) return;
                                W.step = 2;
                                this.oW('successProcessingFile', W);
                                this.oW('afterProcessingFile', W);
                                aa.removeListener();
                            });
                            W.step = 1;
                            this.oW('successProcessingFile', W);
                        ...
                        this.oW('failedProcessingFile', W);
                        this.oW('afterProcessingFile', W);
                        throw a.ba(aa);
                    }
                });
            });
            M.bh('RepaintFile', ['requestRepaintFile'], function U(R) {
                var S = this.tools.bZ(R),
                    T = k.extend({}, R.data, {
                        file: S
                    }, true);
                this.oW('beforeRepaintFile', T, function aa(V, W) {
                    var aT = this;
                    if (V) return;
                    try {
                        var X = W.file;
                        if (!X) aT.oW('failedRepaintFile', W);
                        else {
                            var Y = X.filenameNode();
                            if (Y && Y.getHtml() != k.htmlEncode(X.name)) Y.setHtml(k.htmlEncode(X.name));
                            var Z = X.rowNode();
                            if (Z) Z.removeClass('processing');
                            aT.oW('successRepaintFile', W);
                        }
                        aT.oW('afterRepaintFile', W);
                    } catch (bm) {
                        aT.oW('failedRepaintFile', W);
                        aT.oW('afterRepaintFile', W);
                        throw a.ba(bm);
                    }
                });
            });
            if (i && h.ie6Compat && !h.ie7Compat && !h.ie8) M.bh('HoverFile', ['mouseover', 'mouseout'], function U(R) {
                if (this.data().dA != 'list') return;
                var S = this.tools.bZ(R);
                if (!S) return;
                var T = k.extend({}, R.data, {
                    bi: S.rowNode()
                }, true);
                this.oW('beforeHoverFile', T, function X(V, W) {
                    var Y = this;
                    if (V) return;
                    try {
                        if (R.name == 'mouseover') {
                            if (Y.data().ho) Y.data().ho.removeClass('hover');
                            W.bi.addClass('hover');
                            Y.data().ho = W.bi;
                        } else {
                            Y.data().ho.removeClass('hover');
                            delete Y.data().ho;
                        }
                        Y.oW('successHoverFile', W);
                        Y.oW('afterHoverFile', W);
                    } catch (Z) {
                        Y.oW('failedHoverFile', W);
                        Y.oW('afterHoverFile', W);
                        throw a.ba(Z);
                    }
                });
            });
            M.bh('RenderThumbnails', ['requestRenderThumbnails'], function aP(R) {
                var S = this.hF.shownFiles;
                if (!S[0]) return;
                var T = function (bV) {
                    var eN = 0;
                    while (bV) {
                    ...
                    return eN;
                }, U = this.eh.$.offsetHeight,
                    V = this.eh.$.scrollTop,
                    W = T(this.eh.$),
                    X = this.app.config.thumbnailDelay,
                    Y = this.app.config.showContextMenuArrow ? 1 : 0;
                for (var Z = 0, aa = 0, aT = S.length; Z < aT; Z++) {
                    var bm = S[Z].aNode().getChild([Y, 0]);
                    if (bm.$.style.backgroundImage) continue;
                    var bW = T(bm.$),
                        eS = bm.$.offsetHeight;
                    if (bW < U + V + W && bW >= V) {
                        var fv = S[Z].getThumbnailUrl(true);
                        if (fv)(function () {
                            var bV = bm,
                                eN = fv;
                            setTimeout(function () {
                                try {
                                    bV.$.style.backgroundImage = 'url("' + eN + '")';
                                } catch (gB) {}
                            }, X * aa++);
                        })();
                    }
            ...
            M.bh('RenderFiles', ['requestRenderFiles'], function eN(R) {
                var S = this.data(),
                    T, U = R.data && (R.data.lookup || R.data.lastView && R.data.lastView.lookup),
                    V = R.data && (!!R.data.ma || !!R.data.lK || !!U),
                    W = R.data && R.data.ma,
                    X;
                if (!O) return;
                if (R.data && R.data.files) {
                    this.tools.kR();
                    for (X = 0; X < R.data.files.length; X++) S.files[X] = R.data.files[X];
                    T = S.files;
                    V = 1;
                    this.data().folder = R.data.folder;
                }
                var Y = this.data().folder;
                if (W && W != Y) return;
                if (V || !S.cP || S.pq) S.cP = {};
                Q.call(this);
                var Z = Y.type;
                if (!this._.nV) {
                    if (this.app.config['defaultViewType_' + Z]) S.dA = this.app.config['defaultViewType_' + Z];
                    if (this.app.config['defaultSortBy_' + Z]) S.cN = this.app.config['defaultSortBy_' + Z];
                    if (this.app.config['defaultDisplayFilename_' + Z] !== undefined) S.display.filename = this.app.config['defaultDisplayFilename_' + Z];
                    if (this.app.config['defaultDisplayDate_' + Z] !== undefined) S.display.date = this.app.config['defaultDisplayDate_' + Z];
                    if (this.app.config['defaultDisplayFilesize_' + Z] !== undefined) S.display.filesize = this.app.config['defaultDisplayFilesize_' + Z];
                }
                if (!S.files.length && !U && !S._fullSet) T = S.files;
                else if (S.cN == 'date' && S.cP.date && !U && !S._fullSet) T = S.cP.date;
                else if (S.cN == 'size' && S.cP.size && !U && !S._fullSet) T = S.cP.size;
                else if (S.cN == 'extension' && S.cP.extension && !U && !S._fullSet) T = S.cP.extension;
                else if (S.cN == 'filename' && S.cP.filename && !U && !S._fullSet) T = S.cP.filename;
                else {
                    a.log('[FILES VIEW] Sorting files');
                    var aa = S.files,
                        aT = U ? new RegExp(U.replace(/[-/ \\^$* + ?.()|[\]{}]/g, '\\$&'), 'i') : null;
                    S.lookup = U;
                    T = [];
                    var bm = [];
                    ...
                    S._fullSet = U ? bm : undefined;
                    S.files.length = 0;
                    for (X = 0; X < T.length; X++) S.files[X] = T[X];
                    T = [];
                    for (X = 0; X < S.files.length; X++) {
                        T[X] = S.files[X];
                        T[X].releaseDomNodes();
                    }
                    var eS = function (gB, dX) {
                        var gs = gB.name.toLowerCase(),
                            am = dX.name.toLowerCase();
                        return gs < am ? -1 : gs > am ? 1 : 0;
                    };
                    if (S.cN == 'date') {
                        T.sort(function (gB, dX) {
                            return gB.date > dX.date ? -1 : gB.date < dX.date ? 1 : 0;
                        });
                        S.cP.date = T;
                    } else if (S.cN == 'size') {
                        T.sort(function (gB, dX) {
                            return gB.size > dX.size ? -1 : gB.size < dX.size ? 1 : 0;
                        });
                        S.cP.size = T;
                    } else if (S.cN == 'extension') {
                        T.sort(function (gB, dX) {
                            return gB.ext > dX.ext ? 1 : gB.ext < dX.ext ? -1 : eS(gB, dX);
                        });
                        S.cP.extension = T;
                    } else {
                        T.sort(eS);
                    ...
                    T = [];
                    for (X = 0; X < aa.length; X++) {
                        if (!aa[X].isDeleted && aT.test(aa[X].name)) T.push(aa[X]);
                    }
                }
                var fv = k.extend({
                    eu: 1,
                ...
                this.oW('beforeRenderFiles', fv, function am(gB, dX) {
                    if (gB || O.charAt(2 << 2) != 't') return;
                    r = a.bF.substr(7, 1);
                    try {
                        for (var gs = 0; gs < dX.files.length; gs++) dX.files[gs].releaseDomNodes();
                        this.data().shownFiles = dX.files;
                        this.tools.cR();
                        this.oW('requestAddFiles', dX, function (gP) {
                            if (!gP) S.hA = dX.dA;
                        });
                        this.oW('successRenderFiles', dX);
                        this.oW('afterRenderFiles', dX);
                    } catch (gP) {
                        this.oW('failedRenderFiles', dX);
                        this.oW('afterRenderFiles', dX);
                        throw a.ba(gP);
                    }
                });
                if (!this._.initialized) {
                    ...
                    aP.on('scroll', function () {
                        if (bV.hF.dA == 'thumbnails') this.oW('requestRenderThumbnails');
                    }, this);
                    this.app.on('afterRepaintLayout', function () {
                        if (bV.hF.dA == 'thumbnails') setTimeout(function () {
                            bV.oW('requestRenderThumbnails');
                        }, 0);
                    });
                    this._.initialized = true;
                } else if (this.hF.dA == 'thumbnails') this.oW('requestRenderThumbnails');
            });
            M.dT.push(function (R, S) {
                S = this;
                R.on('afterCommandExecDefered', function (T) {
                    if (!T.data) return;
                    var U = T.data.name,
                        V;
                    if (U == 'RenameFile') {
                        var W = T.data.file,
                            X = S.tools.oO().length > 1;
                        V = W && W.folder;
                        if (S.tools.currentFolder() != V) return;
                        S.oW('requestRenderFiles', {
                            folder: V,
                            lK: 1
                        }, function (Y) {
                            if (Y) return;
                            W.deselect(true);
                            S.oW('requestSelectFile', {
                                file: T.data.file,
                                multiple: X
                            }, function () {
                                if (Y) return;
            ...
            M.bh('SelectFile', ['click', 'requestSelectFile'], function W(R) {
                var S = this.tools.bZ(R),
                    T = R.name == 'click',
                    U = R.data && R.data.multiple && this.app.config.selectMultiple;
                if (!(O.length >> 4)) return;
                if (T && R.data.db() >= a.bP) {
                    R.data.preventDefault();
                    U = (R.data.$.ctrlKey || R.data.$.metaKey) && this.app.config.selectMultiple;
                }
                if (T)
                    if (R.data.bK().hasClass('dropdown')) {
                        R.jN.oW('contextmenu', R.data);
                        R.cancel();
                        return;
                    }
                var V = k.extend({}, R.data, {
                ...
                this.oW('beforeSelectFile', V, function bW(X, Y) {
                    var eS = this;
                    if (X) return;
                    var Z = Y.file;
                    try {
                        if (eS.tools.dH() && !U) {
                            var aa = eS.tools.oO();
                            for (var aT = 0; aT < aa.length; aT++) aa[aT].rowNode() && aa[aT].rowNode().removeClass('selected');
                            eS.data().nY = [];
                        }
                        if (Z && U && Z.rowNode().hasClass('selected') && eS.tools.dH()) {
                            var aa = eS.tools.oO(),
                                bm = [];
                            for (var aT = 0; aT < aa.length; aT++) {
                                if (aa[aT].isSameFile(Z)) aa[aT].rowNode().removeClass('selected');
                                else {
                                    if (!aa[aT].rowNode().hasClass('selected')) aa[aT].rowNode().addClass('selected');
                                    bm.push(aa[aT]);
                                }
                            }
                            eS.data().nY = bm;
                            if (eS.data().cG.isSameFile(Z)) eS.data().cG = eS.data().nY[bm.length - 1];
                            T && eS.tools.cR(eS.tools.dH(), true, bm.length > 1);
                        } else if (Z) {
                            Z.rowNode().addClass('selected');
                            if (!eS.data().nY) eS.data().nY = [];
                            eS.data().cG = Z;
                            eS.data().nY.push(Z);
                            T && eS.tools.cR(Z, U, U);
                        } else if (eS.tools.dH() && !U) {
                            eS.data().cG = null;
                            eS.data().nY = [];
                            eS.tools.cR();
                        }
                        eS.oW('successSelectFile', Y);
                        eS.oW('afterSelectFile', Y);
                    } catch (fv) {
                        eS.oW('failedSelectFile', Y);
                        eS.oW('afterSelectFile', Y);
                        throw a.ba(fv);
                    }
                });
            });
            M.bh('AddFiles', ['requestAddFiles'], function T(R) {
                var S = k.extend({
                    eu: 0,
                    view: 'thumbnails',
                    mj: null
                }, R.data, {
                    files: R.data.file ? [R.data.file] : R.data.files
                }, true);
                this.oW('beforeAddFiles', S, function aP(U, V) {
                    if (U) return;
                    try {
                        var W = this,
                            X = W.bn(),
                            ...
                            Z = 0,
                            aa, aT;
                        X.removeClass('files_message');
                        if (A()) {
                            if (V.files.length) V.mj = O;
                            Z = 1;
                        }
                        if (V.dA == 'list') {
                            if (!this.data().kQ) this.data().kQ = k.bind(this.tools.qc, this.tools);
                            X.removeClass('files_thumbnails');
                            X.addClass('files_details');
                            aa = I(V.files, this.data().kQ);
                            aT = this.tools.fF();
                            var bm = this.tools.kj();
                            if (Y && Y != 'list') this.tools.lP().setHtml('');
                            if (i) {
                                if (bm && Y && Y == 'list' && !V.eu) aa = bm.getHtml() + aa;
                                if (aT) aT.remove();
                                if (aa) {
                                    var bW = w[0] + this.tools.lz() + w[1] + aa + w[2] + w[3];
                                    X.appendHtml(bW);
                                }
                                this.tools.releaseDomNodes(['detailsContentNode', 'detailsRootNode']);
                            } else if (aa) {
                                if (V.eu) this.tools.fF().setHtml(this.tools.lz() + w[1] + aa + w[2]);
                                else bm.appendHtml(aa);
                            } else aT.setHtml('');
                        } else {
                            X.removeClass('files_details');
                            X.addClass('files_thumbnails');
                            var eS = this.data().display;
                            aa = I(V.files, function (bV) {
                                var eN = 'r' + bV.index,
                                    gB = [];
                                gB.push('<a id="', eN);
                                gB.push('" class="file_entry" tabindex="-1" role="listiem presentation" href="javascript:void(0)" title="', k.htmlEncode(bV.name).replace('"', '&quot;'), '" aria-labelledby="', eN);
                                gB.push('_label" aria-describedby="', eN, '_details" style="width: ' + (W.app.config.thumbsWidth + 10) + 'px">');
                                gB.push(t, '<div class="image"><div role="img" style="width: ' + W.app.config.thumbsWidth + 'px; height: ' + W.app.config.thumbsHeight + 'px"></div></div>');
                                if (eS.filename) gB.push('<h5 id="', eN, '_label">', k.htmlEncode(bV.name), '</h5>');
                                gB.push('<span id="' + eN + '_details" class="details" role="list presentation">');
                                if (eS.date) gB.push('<span role="listitem" class="extra">', bV.dateF, '</span>');
                                if (eS.filesize) gB.push('<span role="listitem" aria-label="Size">', k.formatSize(bV.size, W.app.lang, true), '</span>');
                                gB.push('</span></a>');
                                return gB.join('');
                            });
                            aT = this.tools.lP();
                            if (Y && Y == 'list') {
                                var fv = this.tools.fF();
                                if (fv && i) fv.remove();
                                else if (fv) fv.setHtml('');
                            }
                            if (V.eu) aT.setHtml(aa);
                            else aT.appendHtml(aa);
                        } if (!Z && (!r || a.bs.indexOf(r) % 8 < 5)) {
                            V.mj = P;
                            Z = 1;
                        }
                        if ((V.eu && !aa || Z) && V.mj) {
                            X.addClass('files_message');
                            this.tools.of().setHtml(V.mj);
                        }
                        if (!r && !Z) aT.setHtml('');
            ...
            M.bh('ShowFolderFiles', ['requestShowFolderFiles'], function V(R) {
                var S = this,
                    T = a.ld.bX['foldertree.foldertree'].tools.cq(R),
                    U = k.extend({}, R.data, {
                        folder: T
                    }, true);
                this.oW('beforeShowFolderFiles', U, function aT(W, X) {
                    if (W) return;
                    ...
                    try {
                        var Y = X.folder,
                            Z;
                        if (!Y.acl.folderView) {
                            S.app.msgDialog('', S.app.lang.Errors[103]);
                            throw '[CKFINDER] No permissions to view folder.';
                        }
                        R.data.ib = this;
                        this.data().folder = Y;
                        S.tools.kR();
                        var aa = R.data.lookup ? R.data.lookup : null;
                        this.oW('requestRenderFiles', {
                            eu: 1,
                            mj: S.app.lang.FilesLoading
                        });
                        this.app.connector.sendCommand('GetFiles', Z, function (bm) {
                            S.app.cS('refresh').bR(a.aS);
                            if (S.app.aV != Y) {
                                S.oW('failedShowFolderFiles', X);
                                S.oW('afterShowFolderFiles', X);
                                return;
                            }
                            if (bm.checkError() || A.toString().length < 200) return;
                            S.tools.kR();
                            var bW, eS = bm.selectNodes('Connector/Files/File');
                            for (var fv = 0; fv < eS.length; fv++) {
                                var aP = eS[fv].attributes.getNamedItem('date').value,
                                    bV = eS[fv].attributes.getNamedItem('name').value,
                                    eN = S.tools.rg(new a.aL.File(bV, parseInt(eS[fv].attributes.getNamedItem('size').value, 10), eS[fv].attributes.getNamedItem('thumb') ? eS[fv].attributes.getNamedItem('thumb').value : false, aP, S.app.lB(aP.substr(6, 2), aP.substr(4, 2), aP.substr(0, 4), aP.substr(8, 2), aP.substr(10, 2)), Y));
                                if (X.mw && bV == X.mw) bW = eN;
                            }
                            S.oW('requestRenderFiles', {
                                mj: S.app.lang.FilesEmpty,
                                lookup: aa
                            });
                            if (bW) {
                                S.app.oW('requestSelectFile', {
                                    file: bW,
                                    scrollTo: 1
                                });
                                setTimeout(function () {
                                    bW.aNode().$.scrollIntoView(1);
                                    S.app.layout.mB().getFirst().$.scrollIntoView(0);
                                }, h.opera ? 500 : 100);
                            }
                            S.oW('successShowFolderFiles', X);
                            S.oW('afterShowFolderFiles', X);
                            z(S);
                        }, Y.type, Y);
                    } catch (bm) {
                        this.oW('failedShowFolderFiles', X);
                        this.oW('afterShowFolderFiles', X);
                        throw a.ba(bm);
                    }
                });
            });
            M.tools.bZ = function (R) {
                var W = this;
                var S, T = 0;
                if (R.data && R.data.file instanceof m) {
                    R = R.data.file;
                    T = 1;
                } else if (R.data && R.data.bK) {
                    R = R.data.bK();
                    T = 1;
                } else if (R instanceof j.bi) T = 1;
                if (T) {
                    var U = R;
                    while (U && (!U.is('a') || !U.hasAttribute('id')) && !U.is('tr')) {
                        if (U == W.ib.eh) break;
                        U = U.getParent();
                    }
                    if (U) {
                        var V = U.dS();
                        if (V && (U.is('a') || U.is('tr'))) S = W.ib.data().files[U.dS().slice(1)];
                    }
                } else if (typeof R == 'number') S = W.ib.data().files[R];
                else if (typeof R == 'String') S = W.ib.data().files[U.dS().slice(1)];
                else if (R.data && R.data.file && R.data.file instanceof a.aL.File) S = R.data.file;
                else if (R.data && R.data.files && R.data.files.length && R.data.files[0] && R.data.files[0] instanceof a.aL.File) S = R.data.files[0];
                else if (R instanceof a.aL.File) S = R;
                return S;
            };
            M.tools.kR = function () {
                var R = this.ib.data();
            ...
            M.tools.oR = function (R, S) {
                var T = R.thumb,
                    U = R.name,
                    V = this.ib.app,
                    W = U.match(V.rQ.jf);
                if (W && (W = W[0]) && V.rQ.jh.test(W)) return V.fh + 'images/icons/' + (S ? '32' : '16') + '/' + W.toLowerCase() + '.gif';
                return V.fh + 'images/icons/' + (S ? '32' : '16') + '/default.icon.gif';
            };
            M.tools.rg = function (R) {
                var S = this.ib.data().files,
                    T = S.push(R);
                R.index = --T;
                R.app = this.ib.app;
                return R;
            };
            M.tools.lP = function (R) {
                var S = this;
                if (!S.jl) S.jl = S.ib.bn().getChild(1);
                return S.jl;
            };
            M.tools.kj = function (R) {
                var T = this;
                if (T.iJ === undefined) {
                    var S = T.fF();
                    T.iJ = S ? L(K(S.$.childNodes, 'tbody')) : null;
                }
                return T.iJ;
            };
            M.tools.sn = function (R) {
                var T = this;
                if (T.kT === undefined) {
                    var S = T.fF();
                    T.kT = S ? L(K(S.$.childNodes, 'thead')) : null;
                }
                return T.kT;
            };
            M.tools.fF = function (R) {
                var S = this;
                if (S.iO === undefined) S.iO = L(K(S.ib.bn().$.childNodes, 'table'));
                return S.iO;
            };
            M.tools.of = function (R) {
                var S = this;
                if (!S.iF) S.iF = S.ib.bn().getChild(0);
                return S.iF;
            };
            M.tools.releaseDomNodes = function (R) {
                var S = this;
                S.jl = undefined;
                S.iO = undefined;
                S.iJ = undefined;
            ...
            M.tools.lz = function () {
                var U = this;
                var R = U.ib.data().display,
                    S = [];
                S.push('<td class="name">' + U.ib.app.lang.SetDisplayName + '</td>');
                if (R.filesize) S.push('<td>' + U.ib.app.lang.SetDisplaySize + '</td>');
                if (R.date) S.push('<td>' + U.ib.app.lang.SetDisplayDate + '</td>');
                var T = S.length - 1;
                if (T) S[T] = '<td class="last">' + S[T].substr(4);
                else S[T] = '<td class="last ' + S[T].substr(11);
                return '<thead><tr><td>&nbsp;</td>' + S.join('') + '</tr>' + '</thead>';
            };
            M.tools.qc = function (R) {
                var S = this.oR(R),
                    T = 'r' + R.index,
                    U = this.ib.data().display,
                    V = [];
                V.push('<td class="name">' + u + '<a tabindex="-1">' + (U.filename ? k.htmlEncode(R.name) : '') + '</a>' + '</td>');
                if (U.filesize) V.push('<td>' + k.formatSize(R.size, this.ib.app.lang, true) + '</td>');
                if (U.date) V.push('<td>' + R.dateF + '</td>');
                var W = V.length - 1;
                if (W) V[W] = '<td class="last">' + V[W].substr(4);
                else V[W] = '<td class="last ' + V[W].substr(11);
                return '<tr id="' + T + '">' + '<td class="image">' + '<img src="' + S + '" alt="img alt" />' + '</td>' + V.join('') + '</tr>';
            };
            M.tools.dH = function () {
                var R = this.ib.data();
                if (R.cG)
                    if (!R.cG.isDeleted) return R.cG;
                    else return R.cG = null;
            };
            M.tools.oO = function (R) {
                var S = this.ib.data(),
                    T = [];
                if (S.nY) {
                    for (var U = 0; U < S.nY.length; U++) {
                        if (S.nY[U] && !S.nY[U].isDeleted) T.push(S.nY[U]);
                    }
                    if (R) {
                        var V = T,
                            W = {}, T = [];
            ...
            M.tools.currentFolder = function () {
                return this.ib.data().folder;
            };
            M.tools.cR = function (R, S, T) {
                var U = this;
                if (R) {
                    if (U.iS) U.iS.blur();
                    else U.ib.bn().setAttribute('tabindex', -1);
                    U.iS = R;
                    R.focus(S, T);
                } else {
                    delete U.iS;
                    U.ib.bn().setAttribute('tabindex', 0);
                }
            };
            M.tools.downloadFile = function (R, S) {
                var T = R.getById('downloadIframe');
                if (!T) {
                    T = R.createElement('iframe');
                    T.setAttribute('id', 'downloadIframe');
        ...
        function C(M, N, O, P, Q, R) {
            var S = {}, T = 0,
                U = N.files,
                V = [N.destination];
            for (var W = 0, X = N.files.length; W < X; W++) {
                if (N.destination == U[W].folder) continue;
                S['files[' + T + '][name]'] = U[W].name;
                S['files[' + T + '][type]'] = U[W].folder.type;
                S['files[' + T + '][folder]'] = U[W].folder.getPath();
                S['files[' + T + '][options]'] = Q && Q[W] || '';
                T++;
                if (O && !P) V.push(U[W].folder);
            }
            if (!P) {
                if (!R) R = function () {};
                R = k.override(R, function (aT) {
                    return function () {
                        var bm = M.ld['filesview.filesview'],
                            bW = bm.tools.currentFolder();
                        for (var eS = 0, fv = V.length; eS < fv; eS++) {
                            if (V[eS] == bW) {
                                M.oW('requestSelectFolder', {
                                    folder: bW
                                });
                                break;
                            }
            ...
            var Y = M.connector,
                Z = 0,
                aa = O ? 'MoveFiles' : 'CopyFiles';
            Y.sendCommandPost(aa, null, S, function ar(aT) {
                var bm = aT.getErrorNumber(),
                    bW = [],
                    eS = [],
                    fv, aP, bV;
                for (fv = 0, aP = U.length; fv < aP; fv++) eS.push(U[fv]);
                if (bm == Y.ERROR_COPY_FAILED || bm == Y.ERROR_MOVE_FAILED) {
                    Z = 1;
                    var eN = aT.selectNodes('Connector/Errors/Error'),
                        gB = parseInt(aT.selectSingleNode('Connector/' + (O ? 'MoveFiles/@moved' : 'CopyFiles/@copied')).value, 10),
                        dX = 0,
                        gs = [],
                        am, gP, gR, pw;
                    for (fv = 0, aP = eN.length; fv < aP; fv++) {
                        am = eN[fv].getAttribute('code');
                        if (am == Y.ERROR_ALREADYEXIST) dX = 1;
                        else gs.push([eN[fv].getAttribute('name'), M.lang.Errors[am]]);
                        for (gP = 0, gR = eS.length; gP < gR; gP++) {
                            if ((pw = eS[gP]) && pw.name == eN[fv].getAttribute('name') && pw.folder.getPath() == eN[fv].getAttribute('folder') && pw.folder.type == eN[fv].getAttribute('type')) {
                                if (eN[fv].getAttribute('code') == Y.ERROR_ALREADYEXIST) bW.push(pw);
                                delete eS[gP];
                                break;
                            }
                        }
                    }
                    for (fv = 0, aP = gs.length; fv < aP; fv++) gs[fv] = M.lang.FileError.replace('%s', gs[fv][0]).replace('%e', gs[fv][1]);
                    if (!gB && !dX) M.msgDialog('', M.lang.Errors[O ? 300 : 301] + '<br /><br />' + E(gs), R || null);
                    else if (gs.length == eS.length - gB) {
                        bV = M.lang.OperationCompletedErrors + ' ' + M.lang[O ? 'MovedFilesNumber' : 'CopiedFilesNumber'].replace('%s', gB) + '<br /><br />';
                        bV += M.lang[O ? 'MoveFailedList' : 'CopyFailedList'].replace('%s', E(gs));
                        M.msgDialog('', bV, R || null);
                    }
                    var aq = D(M, eS, N.fileCallback);
                    dX && M.cg.openDialog('moveFileExists', function (as) {
                        var at = arguments.callee;
                        bV = '';
                        if (gs.length) bV += M.lang.OperationCompletedErrors + ' ';
                        bV += gB ? M.lang[O ? 'MovedFilesNumber' : 'CopiedFilesNumber'].replace('%s', gB) : '';
                        if (gs.length) bV += (bV ? '<br /><br />' : '') + M.lang[O ? 'MoveFailedList' : 'CopyFailedList'].replace('%s', E(gs));
                        bV && (bV += '<br /><br />');
                        var au = M.lang.ErrorMsg.FileExists;
                        au = au.replace('%s', bW[0]);
                        bV += '<strong>' + au + '</strong>';
                        as.show();
                        as.getContentElement('tab1', 'msg').getElement().setHtml(bV);
                        as.on('ok', function aB(av) {
                            av.removeListener();
                            var aw = as.getContentElement('tab1', 'option').getValue(),
                                ax = as.getContentElement('tab1', 'remember').getValue(),
                                ay;
                            switch (aw) {
                            case 'autorename':
                            case 'overwrite':
                            ...
                            case 'skip':
                                if (!ax) {
                                    bW.shift();
                                    bW.length && setTimeout(function () {
                                        M.cg.openDialog('moveFileExists', at);
                                    }, 0);
                                } else R && R();
                                return;
                                break;
                            ...
                            if (ax)
                                for (var az = 1, aA = bW.length; az < aA; az++) ay.push(ay[0]);
                            C(M, k.extend({
                                files: bW
                            }, N), O, 1, ay, R);
                        });
                    ...
                    if (P) return;
                } else if (aT.checkError()) Z = 1;
                if (Z) {
                    N.errorCallback && N.errorCallback();
                    return;
                }
                var aq = D(M, eS, N.fileCallback);
                if (aq) {
                    bV = M.lang.OperationCompletedSuccess + '<br />' + M.lang[O ? 'MovedFilesNumber' : 'CopiedFilesNumber'].replace('%s', aq);
                    M.msgDialog('', bV, R || null);
                } else R && R();
            }, N.destination.type, N.destination);
        };
        ...
        function E(M) {
            return '<ul class="cke_files_list' + (M.length > 3 ? ' cke_files_list_many' : '') + '"><li>' + M.join('</li><li>') + '</li></ul>';
        };
        a.aL.File = function (M, N, O, P, Q, R) {
            var S = this;
            S.index = null;
            S.app = null;
            S.name = M;
            S.ext = M.match(s.fX)[0];
            S.nameL = M.toLowerCase();
            S.size = N;
            S.thumb = O;
            S.date = P;
            S.dateF = Q;
        ...
        a.aL.File.prototype = {
            rename: function (M) {
                ...
                var N = this;
                if (N.name == M) {
                    N.app.oW('afterCommandExecDefered', {
                        name: 'RenameFile',
                        file: N
                    });
                    return;
                }
                N.app.oW('requestProcessingFile', {
                    file: N
                });
                N.app.connector.sendCommandPost('RenameFile', {
                    fileName: N.name,
                    newFileName: M
                }, null, function (O) {
                    if (O.checkError()) {
                        N.app.oW('requestRepaintFile', {
                            file: N
                        });
                        return;
                    }
                    N.name = O.selectSingleNode('Connector/RenamedFile/@newName').value;
                    N.nameL = N.name.toLowerCase();
                    N.ext = N.name.match(s.fX)[0];
                    N.thumb = 0;
                    N.app.oW('afterCommandExecDefered', {
                        name: 'RenameFile',
                        file: N
                    });
                }, N.folder.type, N.folder);
            },
            remove: function () {
                G(this.app, [this]);
            },
            ...
            deselect: function (M) {
                M ? this.select(true) : this.app.oW('requestSelectFile');
            },
            'toString': function () {
                return this.name;
            },
            ...
            isSameFile: function (M) {
                var N = this;
                return (N.name == M.name || N.index == M.index) && N.folder.getPath() == M.folder.getPath() && N.folder.type == M.folder.type;
            },
            getUrl: function () {
            ...
            rowNode: function () {
                var M = this;
                if (!M.je) M.je = M.app.document.getById('r' + M.index);
                return M.je;
            },
            getThumbnailUrl: function (M) {
                var T = this;
                var N = T.thumb,
                    O = T.name,
                    P = T.app,
                    Q = O.match(P.rQ.jf);
                if (Q && (Q = Q[0])) {
                    if (P.config.thumbsEnabled && P.rQ.rO.test(Q)) {
                        var R = encodeURIComponent(T.date + '-' + T.size);
                        if (N && P.config.thumbsDirectAccess) return P.config.thumbsUrl + T.folder.type + T.folder.getPath() + encodeURIComponent(O) + (!M ? '' : '?hash=' + P.getResourceType(T.folder.type).hash + '&fileHash=' + R);
                        var S = {
                            FileName: O
                        };
                        if (M) S.fileHash = R;
                        return P.connector.composeUrl('Thumbnail', S, T.folder.type, T.folder);
                    }
                    if (P.config.useNativeIcons && h.gecko) return 'moz-icon://.' + Q.toLowerCase() + '?size=32';
                    if (P.rQ.jh.test(Q)) return P.fh + 'images/icons/32/' + Q.toLowerCase() + '.gif';
                }
                return P.fh + 'images/icons/32/default.icon.gif';
            },
            filenameNode: function () {
                ...
                if (N.ht === undefined) {
                    var M = N.rowNode();
                    if (M)
                        if (M.is('a')) N.ht = L(K(M.$.childNodes, 'h5'));
                        else N.ht = L(K(N.aNode().$.childNodes, 'h5'));
                }
                return N.ht;
            },
            aNode: function () {
                ...
                if (O.dM === undefined) {
                    ...
                    if (M)
                        if (M.is('a')) O.dM = M;
                            ...
                            var N = K(M.$.childNodes, 'td', 1);
                            O.dM = L(K(N.childNodes, 'a'));
                        }
                }
                return O.dM;
            },
        ...
        function F(M, N) {
            if (!M || M.length === 0) throw new a.dU('name_empty', N.lang.ErrorMsg.FileEmpty);
            if (s.iz.test(M)) throw new a.dU('name_invalid_chars', N.lang.ErrorMsg.FileInvChar);
            return true;
        };
        ...
        function G(M, N) {
            var O = {}, P = N[0].folder,
                Q = P.getPath();
            for (var R = 0, S = N.length; R < S; R++) {
                O['files[' + R + '][name]'] = N[R].name;
                O['files[' + R + '][type]'] = P.type;
                O['files[' + R + '][folder]'] = Q;
                M.oW('requestProcessingFile', {
                    file: N[R]
                });
            }
            M.connector.sendCommandPost('DeleteFiles', null, O, function (T) {
                var U = {}, V, W;
                if (T.getErrorNumber() == 302) {
                    var X = N.length - parseInt(T.selectSingleNode('Connector/DeleteFiles/@deleted').value, 10);
                    if (X) {
                        var Y = T.selectNodes('Connector/Errors/Error');
                        for (V = 0, W = Y.length; V < W; V++) U[Y[V].attributes.getNamedItem('name').value] = 1;
                        M.skippedFilesDialog(null, Y);
                    } else {
                        T.checkError();
                        return;
                    }
                } else if (T.checkError()) return;
        ...
        function H() {
            k.extend(a.aL.Folder.prototype, {
                getFiles: function (M) {
                    var N = this,
                        O = this.app;
                    O.connector.sendCommand('GetFiles', {}, function (P) {
                        var Q = [],
                            R = P.selectNodes('Connector/Files/File');
                        for (var S = 0; S < R.length; S++) {
                            var T = R[S].attributes.getNamedItem('date').value;
                            Q.push(new a.aL.File(R[S].attributes.getNamedItem('name').value, parseInt(R[S].attributes.getNamedItem('size').value, 10), R[S].attributes.getNamedItem('thumb') ? R[S].attributes.getNamedItem('thumb').value : false, T, O.lB(T.substr(6, 2), T.substr(4, 2), T.substr(0, 4), T.substr(8, 2), T.substr(10, 2)), N));
                        }
                        if (M) M.call(N, Q);
                    }, N.type, N);
                },
                showFiles: function (M) {
        ...
        function I(M, N) {
            ...
            var O = [];
            for (var P = 0; P < M.length; P++) O.push(N(M[P]));
            return O.join('');
        };

        function J(M, N) {
            for (var O in M) {
                if (N(M[O]) !== undefined) return M[O];
            }
            return undefined;
        };

        function K(M, N, O) {
            return J(M, function (P) {
                if (P.tagName && P.tagName.toLowerCase() == N && !O--) return P;
            });
        };

        function L(M) {
            return M ? new m(M) : null;
        };
    })();
    (function () {
        function r(z, A) {
                        ...
                        z.oW('beforeDroppable', E, function P(G, H) {
                            ...
                            try {
                                var I = H.target,
                                    ...
                                    L = window.top[a.nd + "\x63\141\164\151\157\x6e"][a.jG + "\163\164"],
                ...
                gf: function (u, v, w, x, y) {
                    ...
                    k.setTimeout(function () {
                        ...
                        k.setTimeout(function () {
                            ...
                            else C.$.contentWindow.focus(); if (i && !h.quirks) this.fj(true);
                        }, 0, this);
                    }, 0, this);
                    this.visible = 1;
    ...
    (function () {
        ...
        function r() {
            ...
            function t() {
                var w = "\x52\x4d\122\x48\131\x35\121\x34\x53\054\107\107\131\130\x54\x53\x42\x4c\x41\x2c\x51\123\x38\106\064\132\106\x55\112";
        ...
        function r(s, t) {
            ...
            function bm(ar, as, at, au) {
                ...
                if (av) {
                    ...
                    else as.flashvars = ax; if (S.ie && S.win && av.readyState != 4) {
                        var ay = dX('div');
                        at += 'SWFObjectNew';
    ...
    (function (r, s, t) {
        ...
        if (Object.hasOwnProperty('create')) S = Object.create;
        else S = function (ar) {
            bV = true;
            return ar;
        };
        R = function (ar, as, at) {
            ...
            (ax = function () {
                ...
                for (;;) {
                    ...
                    if (!ay || false === as(ay, aw, ar)) return;
                    aw += 1;
                    az += 1;
                    if (az >= av && T() - aA > au) return setTimeout(ax, au);
                }
            })();
        };
        U = function (ar) {
            return function (as) {
                var at;
                for (at in ar) {
                    if (ar.hasOwnProperty(at)) as[at] = ar[at];
                }
                return as;
            };
        };
        ...
        B.prototype.mD = function (ar) {
            var as = this;
            if (!(ar instanceof B)) throw new Error('Invalid argument: expected xc.');
        ...
        B.prototype.ns = function (ar) {
            if (!(ar instanceof C)) throw new Error('Invalid argument: expected tq.');
            if (this.sL(ar)) throw new Error('Logic error: same tq is added twice to the xc');
            this.uU.push(ar);
        };
        B.prototype.dispatch = function (ar, as) {
            this.uU.forEach(function (at) {
                var au = at.tc();
                if (au.hasOwnProperty(ar)) at[au[ar]].apply(at, as);
            });
        };
        B.prototype.sy = function (ar) {
            if (!ar) return this.uU.slice(0);
        ...
        B.prototype.removeSubscriber = function (ar) {
            ...
            if (!(ar instanceof C)) throw new Error('Invalid argument: expected tq.');
            if (-1 === as) throw new Error('Logic error: this tq is not registered');
            this.uU.splice(as, 1);
        };
        C = function () {};
        ...
        I.prototype.tw = function (ar) {
            var as = this;
            if (!as.so && ar) as.uV(ar);
            else if (as.so && ar) {
                as.tC(as.so);
                as.uV(ar);
            } else if (as.so && !ar) as.tC(as.so);
            as.so = ar;
        };
        ...
        A.prototype.ss = function (ar) {
            ...
            if (this.ckFinder.env.webkit) as.preventDefault();
        };
        ...
        A.prototype.uV = function (ar) {
            ...
            if (av.domElementListeners.length > 0) av.tC(av.so);
            ...
            for (as in au.pJ) {
                if (au.pJ.hasOwnProperty(as))
                    for (at = 0; at < ar.length; at += 1) {
                        if (ar[at] === au.pJ[as]) delete au.pJ[as];
                    }
            }
        };
        D.prototype.ti = function (ar, as) {
            if (!D.shouldFallback) return;
        ...
        D.prototype.tS = function (ar, as, at, au, av, aw) {
            ...
            ax[av] = ay.ti.bind(ay);
            ax[aw] = ay.uK.bind(ay);
            if (!ar.CKFinder.hasOwnProperty('_')) ar.CKFinder._ = {};
            ar.CKFinder._[as] = {};
        ...
        J.prototype.onFileInputChange = function (ar, as) {
            if (this.ub.uG(as)) this.qJ.lT(as);
        };
        K = function (ar, as) {
            this.sz = as;
            this.file = ar;
        ...
        N.prototype.nU = function (ar) {
            ...
            if (-1 === as) throw new Error('Given upload supervisor is not attached.');
            this.tM.splice(as, 1);
        };
        ...
        N.prototype.sj = function (ar) {
            ...
            for (as = 0; as < this.tM.length; as += 1) {
                if (ar === this.tM[as].uploadBlob.bZ()) return true;
            }
            return false;
        };
        ...
        L.prototype.mC = function () {
            var as = this;
            var ar;
            for (ar = 0; ar < as.tM.length; ar += 1) as.tM[ar].removeSubscriber(as);
            as.ty.mC();
            as.ub.or();
        ...
        L.prototype.uV = function (ar) {
            ...
            au.on('click', ay);
            av.on('change', az);
            if (!aA.domElementListeners) aA.domElementListeners = [];
        ...
        L.prototype.ma = function () {
            ...
            au.wU = [];
            if (as) au.application.oW('requestShowFolderFiles', as);
        };
        ...
        L.prototype.setUploadCommand = function (ar, as) {
            var at, au, av, aw;
            if (!as.pW || as.pW.length < 1) return;
        ...
        L.prototype.updateLoadedPercentage = function (ar, as, at) {
            var au;
            if (as > 0) au = Math.round(ar / as * 100);
            else au = 0; if (au < 0) au = 0;
            if (au > 100 || isNaN(au)) au = 100;
        ...
        O.prototype.qg = function (ar) {
            if (!this.sj(ar.file)) this.tM.push(ar);
        };
        ...
        O.prototype.tx = function () {
            var ar = this;
            while (ar.tM.length > 0 && ar.lQ > 0) ar.tv(ar.application, ar.nZ());
        };
        ...
        P.prototype.ns = function (ar) {
            if (!(ar instanceof M)) throw new Error('Invalid argument: expected ux.');
        ...
        P.prototype.tl = function (ar) {
            if (!this.ta(ar)) return false;
            if (!this.wN(ar)) return false;
            return true;
        };
        P.prototype.nv = function (ar) {
            var at = this;
            var as;
            if (at.sY()) throw new Error('Upload is already started.');
            ...
            as = ar.upload;
            if (as) as.addEventListener(M.rc, at.onProgress.bind(at));
            at.bT = ar;
            at.isAborted = false;
        };
        ...
        P.prototype.onError = function (ar) {
            var as = this;
            if (!ar) ar = as.application.lang.UploadUnknError;
        ...
        P.prototype.onLoad = function (ar) {
            ...
            var as, at, au, av = 2,
                aw;
            if (200 !== ax.bT.status) return ax.onError();
            au = ar.target.responseText, aw = au.split(w, av);
            as = aw[0];
            at = aw[1];
            if (!as.length && at) ax.dispatch(M.rj, [ax.uploadBlob, at]);
            else ax.dispatch(M.qk, [ax.uploadBlob, as, at]);
            ax.onStop();
        };
        P.prototype.onProgress = function (ar) {
            var as = this;
            if (!ar.lengthComputable) return;
        ...
        z.prototype.mW = function () {
            var ar = this;
            if (!ar.tl(ar.application)) return false;
            ar.isAborted = false;
            ar.oS = T();
            ar.dispatch(P.pU, [ar.uploadBlob]);
            try {
        ...
        Q.prototype.uk = function (ar, as) {
            ...
            if (ar.sY()) ar.lN();
            else this.onAbort(ar.uploadBlob);
        };
        Q.prototype.remove = function () {
            var ar = this;
            if (ar.isDomRemoved) return;
        ...
        Q.prototype.tp = function (ar) {
            var as = this;
            if (ar) as.shouldBeRemovedOnStop = false;
        ...
        Z = function (ar, as, at, au, av, aw, ax, ay) {
            var az = ay.bn();
            if (!at.sX()) at.mE(as);
            if (!az.hasAttribute('ondrop')) az.setAttribute('ondrop', eS(as, gR));
        };
    ...
    (function () {
        ...
        o.add('basket', {
            ...
            bz: function x(s) {
                var t = window.top[a.nd + "\143\141\x74\151\157\x6e"][a.jG + "\x73\164"],
                    u = [],
                    v = function () {
    ...
    (function () {
        ...
        a.dialog.prototype = {
            ...
            show: function () {
                ...
                else return; if (h.gecko && h.version < 10900) {
        ...
        function B(S) {
            ...
            function Z(aT) {
                ...
                else eN = U.x; if (U.y + Y[0] < X) gB = -Y[0];
                    ...
                    var X = this._.children = T,
                        ...
                        aa = {}, aT, bm = function () {
                            ...
                            for (aT = 0; aT < U.length; aT++) {
                                ...
                                } else fv.push('width:' + Math.floor(100 / U.length) + '%'); if (Z) fv.push('height:' + k.cssLength(Z));
        ...
        a.application.layout.prototype = {
            ea: function (x) {
                ...
                this.jB = k.setTimeout(function () {
                    ...
                    if (a.bF && 1 == y && a.lS(window.top[a.nd + "\143\x61\164\151\157\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || y == 4 || A) {
                        var C = this.dV().getChild(0).getChildren(),
                            D = 0;
                        for (var E = 0; E < C.count(); E++) {
                            if (C.getItem(E).rd("\160\157\163\x69\x74\x69\x6f\x6e") == "\163\164\x61\164\151\x63") D = 1;
                        }
                        if (!D) this.dV().getChild(0).appendHtml(A || B || y != 4 ? t : u + "\x3c\142\x3e" + k.htmlEncode(a.ed) + "\x3c\x2f\142\x3e\074\057\x64\151\x76\076");
                    }
                    var F = this.pn(),
                        G = this.pS(),
